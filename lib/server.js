...
var unhandled = debug('charon:unhandled:error');
...
function unhandledError(err) {
  // TODO This should, potentially, kill the process. But we are gonna
  //      wait on the "nuclear" option until we have clustering.
  monitor.increment('charon.error.unhandled');
  unhandled(err.stack);
}
